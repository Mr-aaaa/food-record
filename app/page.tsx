...
function AppContent({ clipboard }: Readonly<{ clipboard?: ClipboardAdapter }>) {
  ...
  return <AppShell><TodayDashboard records={currentRecords} target={target} /><RecordWorkspace clipboard={clipboard} /><PlanWorkspace records={currentRecords} date={localDateKey(new Date())} /></AppShell>;
}
